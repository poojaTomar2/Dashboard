...
ResponsiveDatatablesHelper.prototype.init=function(breakpoints,options){this.origBreakpointsDefs=breakpoints;this.initBreakpoints();this.disable(!1);$.extend(this.options,options)};ResponsiveDatatablesHelper.prototype.initBreakpoints=function(){if(this.saveState){this.getState()}
...
$('.columnValue',li).append(clonedContents).data('originalTdSource',td);li.attr('data-column',index);var tdClass=$(td).attr('class');if(tdClass!=='undefined'&&tdClass!==!1&&tdClass!==''){li.addClass(tdClass)}
ul.append(li)}}
