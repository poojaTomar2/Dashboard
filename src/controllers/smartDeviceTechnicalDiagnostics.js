...
var ListBaseController = require('./listBaseController'),
	SmartDeviceTechnicalDiagnosticsModel = require('../models').SmartDeviceTechnicalDiagnostics,
	aggregators = require('./aggregators'),
	client = require('../models').elasticClient;

class SmartDeviceTechnicalDiagnostics extends ListBaseController {
	get modelType() {
		return SmartDeviceTechnicalDiagnosticsModel;
	}
